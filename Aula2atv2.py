...
form_name.send_keys("Clislânia")

form_email = navegador.find_element(By.NAME, "email").send_keys("clislaniabs@gmail.com")
form_body = navegador.find_element(By.NAME, "body").send_keys("Primeira automação com Selenium Web Driver")
